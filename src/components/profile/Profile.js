                                                    ...
                                                    <div className="posts-bar">
                                                        <div className="post-bar bgclr">
                                                            <div className="wordpressdevlp">
                                                                ...
                                                                <div className="row no-gutters">
                                                                    <div className="col-md-6 col-sm-12">
                                                                        <p className="posttext"><i
                                                                            className="la la-clock-o"></i>Posted on 5
                                                                            June 2018</p>
                                                                    </div>
                                                                    <div className="col-md-6 col-sm-12">
                                                                        <p><i className="la la-clock-o"></i>Expiried on
                                                                            5 October 2018</p>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div className="post_topbar post-reply">
                                                            <div className="usy-dt">
                                                                ...
                                                                <div className="usy-name">
                                                                    <h3>John Doe</h3>
                                                                    <div className="epi-sec epi2">
                                                                        <p><i className="la la-clock-o"></i>3 min
                                                                            ago</p>
                                                ...
                                                <div className="post-bar">
                                                    ...
                                                    <div className="epi-sec">
                                                        ...
                                                        <ul className="bk-links">
                                                            ...
                                                            <li><a href="#" title="" className="bid_now">Bid Now</a>
                                                            </li>
                                                        </ul>
                                                    </div>
                                        ...
                                        <div className="product-feed-tab" id="portfolio-dd">
                                            <div className="portfolio-gallery-sec">
                                                ...
                                                <div className="portfolio-btn">
                                                    <a href="#" title=""><i className="fa fa-plus-square"></i> Add
                                                        Portfolio</a>
                                                </div>
